    ...
    try:
        ...
        for obId in obIds:
            try:
                ...
                if not ob['images'].get('image') == None:
                    ...
                    for img in ob['images']['image']:
                        try:
                            ...
                            print("Fetched image for " + str(obJSON['id']) + " in " + str(img_time_end - img_time_start) + "s")                            
                ...
                time_end = time.time()
                print("Fetched id " + str(obJSON['id']) + " in " + str(time_end - time_start) + "s :: In date " + date)
            except Exception as err:
